...
venue: "Fermilab LHC Physics Center (LPC)"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
instructor: ["Matt Bellis", "Edgar Carrera", "Thomas Gaehtgens", "Allan Da Silva Jales", "Julie Hogan", "Clemens Lange", "Kati Lassila-Perini", "Santeri Laurila", "Adelina Lintuluoto", "Tom McCauley", "Sezen Sekmen", "Jesse Thaler"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
